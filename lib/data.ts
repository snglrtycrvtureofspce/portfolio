...
export const experiencesData = [
  ...
  },
  {
    ...
    tags: ["C#", "ASP.NET Core", ".NET Core", "Entity Framework Core", "MediatR", "FluentValidation", "AutoMapper", "Refit", "Serilog", "JWT Auth", "NUnit", "AWS (Amazon S3, IAM)", "SonarQube", "RabbitMQ", "Hangfire", "SignalR", "Firebase", "Elasticsearch", "Docker", "Portainer", "SQL", "Microsoft SQL Server", "CI/CD", "Git"],
